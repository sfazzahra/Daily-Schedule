  ...
  <div class="container">
    <aside class="sidebar">
      ...
      <nav class="menu">
        ...
        <button onclick="location.href='dashboardd.php'">Dashboard</button>
        <button onclick="location.href='dosen.php'">Create Task</button>
        <button onclick="location.href='historyy.php'">History</button>
